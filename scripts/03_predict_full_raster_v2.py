...
BANDS_10M_DIR = os.path.join(BASE_DIR, "data", "cropped", "bands_10m")
BANDS_20M_DIR = os.path.join(BASE_DIR, "data", "cropped", "bands_20m")
...
OUTPUT_RASTER = os.path.join(RASTERS_DIR, "classified_hunga_tonga_v2.tif")
OUTPUT_AREA_CSV = os.path.join(METRICS_DIR, "area_by_class_v2.csv")
OUTPUT_MAPPING_CSV = os.path.join(METRICS_DIR, "class_mapping_v2.csv")
...
band_paths = {
    "B02": os.path.join(BANDS_10M_DIR, "B02_10m.tif"),
    "B03": os.path.join(BANDS_10M_DIR, "B03_10m.tif"),
    "B04": os.path.join(BANDS_10M_DIR, "B04_10m.tif"),
    "B08": os.path.join(BANDS_10M_DIR, "B08_10m.tif"),

    "B05": os.path.join(BANDS_20M_DIR, "B05_20m.tif"),
    "B06": os.path.join(BANDS_20M_DIR, "B06_20m.tif"),
    "B07": os.path.join(BANDS_20M_DIR, "B07_20m.tif"),
    "B8A": os.path.join(BANDS_20M_DIR, "B8A_20m.tif"),
    "B11": os.path.join(BANDS_20M_DIR, "B11_20m.tif"),
    "B12": os.path.join(BANDS_20M_DIR, "B12_20m.tif"),
}
...
if not os.path.exists(LABEL_ENCODER_PATH):
    raise FileNotFoundError(f"No se encontró el label encoder: {LABEL_ENCODER_PATH}")
...
print("Cargando modelo y label encoder...")
...
try:
    ...
    print("Clasificando raster recortado por bloques...")
    ...
    print("Raster clasificado guardado en:")
    print(OUTPUT_RASTER)
