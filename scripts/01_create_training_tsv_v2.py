...
POLYGONS_PATH = os.path.join(BASE_DIR, "data", "cropped", "polygons", "training_polygons_v2.geojson")

OUTPUT_DIR = os.path.join(BASE_DIR, "outputs_v2", "tsv")
os.makedirs(OUTPUT_DIR, exist_ok=True)

OUTPUT_TSV = os.path.join(OUTPUT_DIR, "training_data_v2.tsv")
...
print(f"Archivo TSV v2 guardado en: {OUTPUT_TSV}")